...
SOAP::SOAPNamespaceTag = 'env' unless defined?(SOAP::SOAPNamespaceTag)
SOAP::XSDNamespaceTag  = 'xsd' unless defined?(SOAP::XSDNamespaceTag)
SOAP::XSINamespaceTag  = 'xsi' unless defined?(SOAP::XSINamespaceTag)
